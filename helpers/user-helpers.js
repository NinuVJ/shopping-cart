...
var instance = new Razorpay({
    key_id: 'rzp_test_WSFuPsrwUUo81c',
    key_secret: 'jjVupslLwgujpamXrRChsMp7',
  });
...
module.exports = {
    doSignup: (userData) => {
        return new Promise(async (resolve, reject) => {
            ...
            db.get().collection(collection.USER_COLLECTION).insertOne(userData).then((data) => {
                let userss = db.get().collection(collection.USER_COLLECTION).find().toArray()
                resolve(userss)
            })
    ...
    verifyPayment:(details)=>{
        return new Promise((resolve,reject)=>{
            ...
            let hmac=crypto.createHmac('sha256','jjVupslLwgujpamXrRChsMp7')
